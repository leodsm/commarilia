      ...
      <div className="relative bg-white w-full h-[90vh] md:h-auto md:max-h-[90vh] md:max-w-2xl rounded-t-2xl md:rounded-2xl overflow-hidden shadow-2xl flex flex-col animate-slide-up">
        ...
        >
          ...
          <div className="p-6 md:p-8">
            ...
            <button
                onClick={onClose}
                className="w-full py-4 bg-gray-100 hover:bg-gray-200 text-gray-800 font-bold rounded-xl transition-colors text-lg flex items-center justify-center gap-2"
            >
                Fechar Notícia
